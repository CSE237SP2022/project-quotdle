...
class AnswerGeneratorTests {
	...
	//not sure if this helps me here (contained no code when I loaded this first to edit)
	@BeforeAll
	...
	public void getIndexQuordleAnswerTestAccuracy() {
		...
		String[] correctAnswer = new String[]{"a", "piece", "of", "cake"};
	...
	/*
	 * see AnswerGenerator (keeping this code since it might be needed in a way I don't see, but not using it rn)
	@Test
	public void getWordleAnswerTest() {
		for(int i = 0; i < 10; ++i) {
